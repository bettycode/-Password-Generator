...
function generatePassword(){
  ...
  //prompt for the length of the password 
    var passwordLength = parseInt(prompt("How many characters do you want? It  cannot be less than 8 or more than 128 characters."));
  // if the lenth of password < 8 alert "pleas select number that is >= 8 characters."
   ...
   passwordLength = parseInt(prompt("How many characters do you want? It  cannot be less than 8 or more than 128 characters."));
   }
